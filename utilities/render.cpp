...
void CFontManager::createFonts( )
{
	...
	this->segoe = g_Interfaces->surface->reserveFont( );
	this->segoeS = g_Interfaces->surface->reserveFont( );
	this->segoeI = g_Interfaces->surface->reserveFont();

	g_Interfaces->surface->setupFont(this->segoeI, "Segoe UI", 18, 400, 0, 0, ESurfaceFlags::FONTFLAG_GAUSSIANBLUR | ESurfaceFlags::FONTFLAG_ANTIALIAS | ESurfaceFlags::FONTFLAG_ITALIC, 0, 0);
	g_Interfaces->surface->setupFont(this->segoeS, "Segoe UI", 18, 400, 0, 0, ESurfaceFlags::FONTFLAG_GAUSSIANBLUR | ESurfaceFlags::FONTFLAG_ANTIALIAS, 0, 0);
	g_Interfaces->surface->setupFont(this->segoe, "Segoe UI", 70, 200, 0, 0, ESurfaceFlags::FONTFLAG_GAUSSIANBLUR | ESurfaceFlags::FONTFLAG_ANTIALIAS, 0, 0);
