...
void CMath::SmoothAngle(Vector3 src, Vector3& dst, float factor)
{

	float goodFactor = factor * 0.25;

	Vector3 delta = dst - src;

    vectorNormalize(delta);

	dst = src + delta / goodFactor;
}
...
float CMath::normalizeYaw2(float flAngle) {
