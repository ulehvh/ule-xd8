...
public:
	...
	Vector3 Direction()
	{
		return Vector3(cos(y * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(y * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(-x * M_PI / 180.0f)).Normalized();
	}
	...
	Vector3 Up()
	{
		return Vector3(cos(y * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(y * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(-(x - 90.0f) * M_PI / 180.0f)).Normalized();
	}

	Vector3 Right()
	{
		return Vector3(cos((y + 90.f) * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin((y + 90.f) * M_PI / 180.0f) * cos(x * M_PI / 180.0f), sin(-x * M_PI / 180.0f)).Normalized();
	}
